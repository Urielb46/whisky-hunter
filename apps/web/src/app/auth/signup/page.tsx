        ...
        >
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm" style={{ color: 'var(--text-muted)' }}>
              Track prices. Build your wishlist. Never overpay.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="mb-1.5 block text-xs font-medium" style={{ color: 'var(--text-subtle)' }}>Name</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="mb-1.5 block text-xs font-medium" style={{ color: 'var(--text-subtle)' }}>Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="mb-1.5 block text-xs font-medium" style={{ color: 'var(--text-subtle)' }}>Password</label>
            ...
            <label className="flex items-start gap-2.5 cursor-pointer">
              ...
              <span className="text-xs" style={{ color: 'var(--text-muted)' }}>
                I confirm I am 21 or older and agree to use this service responsibly.
              </span>
            </label>
